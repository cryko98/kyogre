      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="aspect-square w-full max-w-[500px] mx-auto bg-black border border-red-900/20 flex items-center justify-center relative overflow-hidden group">
              {loading ? (
                ...
                <div className="p-8 text-center">
                  <div className="text-red-600 font-bold text-sm mb-4 uppercase">FORGE ERROR</div>
                  <p className="text-slate-500 text-[10px] uppercase font-mono leading-relaxed max-w-xs mx-auto">{error}</p>
                </div>
              ) : (
          ...
          <p className="text-slate-600 text-[10px] uppercase tracking-widest font-bold">
            Powered by Gemini 2.5 Flash • Direct API Access
          </p>
        </div>
      </div>
    </section>
